...
| `agency-client-cost-report.ipynb` | Per-client cost attribution for an agency — category caps, a caught loop, and a client report built straight from the ledger; optional webhook forward to your reporting/observability stack | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/figuard/figuard-notebooks/blob/main/agency-client-cost-report.ipynb) |
